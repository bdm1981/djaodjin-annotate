...
(function($) {
  ...
  Annotate.prototype = {
    init: function() {
      ...
      if (self.options.styleWidth) {
        self.$el.append(
          $(
            '<canvas id="' +
              self.baseLayerId +
              '" style="width: ' +
              self.options.styleWidth +
              'px;"></canvas>'
          )
        );
        self.$el.append(
        ...
        self.$el.append(
          $('<canvas id="' + self.drawingLayerId + '></canvas>"')
        );
      }
      ...
      if (self.options.bootstrap) {
        ...
        self.$tool +=
          ...
          '<div class="btn-group">' +
          '<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" area-expanded="false">' +
          'Color <span class="caret"><span>' +
          "</button>" +
          '<ul class="dropdown-menu">' +
          '<li><a href="#" class="selectColor" data-color="black" style="color: black;">Black</a></li>' +
          '<li><a href="#" class="selectColor" data-color="blue" style="color: blue;">Blue</a></li>' +
          '<li><a href="#" class="selectColor" data-color="green" style="color: green;">Green</a></li>' +
          '<li><a href="#" class="selectColor" data-color="orange" style="color: orange;">Orange</a></li>' +
          '<li><a href="#" class="selectColor" data-color="red" style="color: red;">Red</a></li>' +
          '<li><a href="#" class="selectColor" data-color="yellow" style="color: yellow;">Yellow</a></li>' +
          '<li><a href="#" class="selectColor" data-color="white">White</a></li>' +
          "<ul></div>" +
          '<div class="btn-group">' +
          '<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" area-expanded="false">' +
          ...
          "</button>" +
          '<ul class="dropdown-menu">' +
          '<li><a href="#" class="selectThickness" data-linewidth="5"><div style="background-color: black; width: 150px; height: 5px; text-decoration: none;"></div></a></li>' +
          '<li><a href="#" class="selectThickness" data-linewidth="10"><div style="background-color: black; width: 150px; height: 8px; text-decoration: none;"></div></a></li>' +
          '<li><a href="#" class="selectThickness" data-linewidth="15"><div style="background-color: black; width: 150px; height: 14px; text-decoration: none;"></div></a></li>' +
          '<li><a href="#" class="selectThickness" data-linewidth="20"><div style="background-color: black; width: 150px; height: 18px; text-decoration: none;"></div></a></li>' +
          '<li><a href="#" class="selectThickness" data-linewidth="25"><div style="background-color: black; width: 150px; height: 20px; text-decoration: none;"></div></a></li>' +
          "<ul></div>" +
      ...
      $(document).on("click", ".selectColor", function(event) {
        ...
        self.options.color = $(this).data("color");
      });
      $(document).on("click", ".selectThickness", function(event) {
        event.preventDefault();
        self.options.linewidth = $(this).data("linewidth");
      });
      $(document).on(
    ...
    setBackgroundImage: function(image) {
      ...
      self.img.onload = function() {
        ...
        var styleHeight = self.currentHeight;
        if (self.options.styleWidth) {
          styleHeight =
            (self.currentHeight * self.options.styleWidth) / self.currentWidth;
        }
        self.$el.css({
          width: self.options.styleWidth || self.currentWidth,
          height: styleHeight
        });
    ...
    drawRectangle: function(context, x, y, w, h, color, lineWidth) {
      ...
      context.fill();
      context.lineWidth = lineWidth || self.options.linewidth;
      context.strokeStyle = color || self.options.color;
      context.stroke();
    },
  ...
  $.fn.annotate = function(options, cmdOption, callback) {
    ...
    if (options === "destroy") {
      ...
      $annotate.options[cmdOption.element] = cmdOption.value;
